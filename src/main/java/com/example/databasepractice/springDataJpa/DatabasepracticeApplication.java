...
public class DatabasepracticeApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("insert -> " + repository.save(new Person("Makr", "LA", LocalDate.of(1992, 3, 5))));
		System.out.println("update -> " + repository.save(new Person(13,"patcummin", "Australia", LocalDate.of(1992, 3, 5))));
